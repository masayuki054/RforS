...
** Doing 検定 (RforS-5, K-11)
   ...
   - [-] RforS [[./org/RforS-II-05.org]] [4/8]  - 鈴木のまとめ
...
** Doing 検定 (RforS-6, K-11)
  
   - [[http://whitewell.sakura.ne.jp/R/][Webpage for Probability Theory and Statistics (B)]] のRで統計学を学
     ぶ(4) - 中京大 白井先生のコンテンツ
	 
   - RforS [[file:org/RforS-II-06.org::*6章 2つの平均値を比較する][6 2つの平均値を比較する]] [0/3]
...
-[[file:~/COMM/Lects/R/RforStatistcs/RforS/org/RforS-II-05.org::*5.2 統計的仮説検定の手順と用語][ R5.2 統計的仮説検定の手順と用語]]
 ...
 - [[file:~/COMM/Lects/R/RforStatistcs/RforS/org/RforS-II-05.org::5.2.5 p 値][5.2.5 p 値]]
...
- [[file:~/COMM/Lects/R/RforStatistcs/RforS/org/RforS-II-05.org::*5.6 独立性の検定（カイ二乗検定）][5.6 独立性の検定（カイ二乗検定）]]
  ...
  - [[file:~/COMM/Lects/R/RforStatistcs/RforS/org/RforS-II-05.org::*p 値][p 値]]
...
* Doing 参考書
     - [[https://www.jstat.or.jp/openstatistics/][データ分析のための統計学入門 原著第4版 “OpenIntro Statistics Fourth Edition”]]
