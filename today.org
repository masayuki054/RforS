...
** Doing 二つの平均値の比較検定 (RforS-6, K-11)
   ...
   - RforS [[file:org/RforS-II-06.org]] [0/3]
     - [ ]  [[file:org/RforS-II-06.org::6.1 2つの平均値を比較するケース][6.1 2つの平均値を比較するケース]]
     - [ ]  [[file:org/RforS-II-06.org::6.2 独立な2群の検定][6.2 独立な2群の検定]] [0/3]
     ...
     - [ ]  [[file:org/RforS-II-06.org::6.3 t-検定の前提条件][6.3 t-検定の前提条件]] [0/3]
...
** 分散分析 (RforS-7, K-12) [0/2]
   ...
   - [ ] RforS-7 分散分析
     ...
     - RforS [[file:org/RforS-II-07.org]] [0/3]
       - [ ] 7.0 変動の区別
       - [ ] 7.1 一元配置分散分析
         - [ ] 検定の流れ
         - [ ] Rによる変動と検定値の計算
