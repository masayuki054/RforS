...
** Todo お知らせ   SCHEDULED: <2021-11-01 月>

   1回目のレポートを出題しました。Webclassを見てください。
   〆切は，いちおう，11/15日です。   
...
*** 講師のノート
    ...
    - 昨年の講義ノート [[https://drive.google.com/drive/folders/1vFIqux3NytwvUEygZ74O9XzuyCoJfj7D][lect-note - Google ドライブ]]  の7章，5章
    - [[http://whitewell.sakura.ne.jp/R/Rstatistics-03.html][Rで統計学を学ぶ(3)]] を参考にしてください。
    - [[https://drive.google.com/drive/u/0/folders/10uKe0TnjEjoQxigeXfyjh_4ZTzxmoCNI][board-2020 - Google ドライブ]]
...
**** Doing 標本と統計的推測 [0/3]
     ...
     - [ ] 標本平均  K-7 (教科書7章，5章と講師の講義ノート) [0/5]
       - [ ] 標本平均の確率収束値
       - [ ] 標本平均が従う分布
       - [ ] 標本平均の期待値
       - [ ] 標本平均の分散
     ...
     - [ ] 標本不偏分散 K-7 (教科書7章，5章と講師の講義ノート) [0/4]
       - [ ] 標本分散の確率収束値
       - [ ] 標本分散が従う分布
       - [ ] 標本分散(が従う分布)の期待値
       - [ ] 標本分散(が従う分布)の分散
