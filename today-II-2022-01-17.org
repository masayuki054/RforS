...
** Doing 検定 (RforS-5, K-11)
   - [X] RforS [[./org/RforS-II-05.org]] [4/4]  - 鈴木のまとめ
     - [X] R5.7 サンプルサイズの検定結果への影響について
...
** Doing 二つの平均値の比較検定 (RforS-6, K-11)
  
   - [[http://whitewell.sakura.ne.jp/R/][Webpage for Probability Theory and Statistics (B)]] のRで統計学を学
     ぶ(5) - 中京大 白井先生のコンテンツ
	 
   - RforS [[file:org/RforS-II-06.org]] [3/3]
     - [X]  [[file:org/RforS-II-06.org::6.1 2つの平均値を比較するケース][6.1 2つの平均値を比較するケース]]
     - [X]  [[file:org/RforS-II-06.org::6.2 独立な2群の検定][6.2 独立な2群の検定]] [3/3]
       - [X] [[file:org/RforS-II-06.org::分散既知 あるいは 大標本の場合 (z-検定)][分散既知 あるいは 大標本の場合 (z-検定)]]
       - [X] [[file:org/RforS-II-06.org::分散未知の場合 (t-検定)][分散未知の場合 (t-検定)]]
       - [X] [[file:org/RforS-II-06.org::例題][例題]]
     - [X]  [[file:org/RforS-II-06.org::6.3 t-検定の前提条件][6.3 t-検定の前提条件]] [3/3]
       - [X] [[file:org/RforS-II-06.org::6.3.1 分散の等質性の検定][6.3.1 分散の等質性の検定]]
       - [X] [[file:org/RforS-II-06.org::6.4 対応のある (z,t)-検定][6.4 対応のある (z,t)-検定]]
       - [X] [[file:org/RforS-II-06.org::対応のあるデータの検定量][対応のあるデータの検定量]]
    
** 分散分析 (RforS-7, K-12) [1/2]
   - [X] 分散分析理論
     - https://www.ouj.ac.jp/mijika/tokei/xml/k3_06023.xml
     - [[http://lbm.ab.a.u-tokyo.ac.jp/~omori/noko/linearmodel.html][生物統計学３]] 分散分析
       - [[./org/Stat-variance-analysis.org]]

   - [ ] RforS-7 分散分析

      [[http://whitewell.sakura.ne.jp/R/][Webpage for Probability Theory and Statistics(B)]]
      のRで統計学を学ぶ(5) - 中京大 白井先生のコンテンツ
	 
     - RforS [[file:org/RforS-II-07.org]] [2/3]
       - [X] 7.0 変動の区別
       - [X] 7.1 一元配置分散分析
         - [X] 検定の流れ
         - [X] Rによる変動と検定値の計算
           - 全体差, 群間差, 群内差, 平方和と自由度とF-値
         - [X] 多重比較 (Tukey の方法)
...
*** 検定 [[file:org/RforS-II-06.org][6章 2つの平均値を比較する]]
...
** [2022-01-17 月] 1/12の講義の録画

http://wiki.cis.iwate-u.ac.jp/~suzuki/stat2/records

** [2022-01-11 火] 1/31 に期末試験を行ないます。

    [[./reports.org]]
    
** [2022-01-12 水] 5回目のレポートを出題しました。
    [[./reports.org]]
