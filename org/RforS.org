...
**** 簡単な計算   [[http://cse.naro.affrc.go.jp/takezawa/r-tips/r/03.html][R-Source::簡単な計算 ]] 
...
*** Rをもっとさわってみよう 1.5  [[http://cse.naro.affrc.go.jp/takezawa/r-tips/r/12.html][R-Source::ベクトルの作成]]
...
#+begin_src R :session t :results output :exports both :tangle ~/Lects/R/
(varp <- function (x) {
