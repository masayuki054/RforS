...
table(不偏分散誤差100以上)
     ...
     #+begin_src R :results graphics :file RforS-graphs/04-16-1.png :session t :tangle RforS-Codes/04-06,R
##
## 標本分散の頻度表
...
#+RESULTS:
     ...
     #+begin_src R :results graphics :file RforS-graphs/04-16-2.png :session t :tangle RforS-Codes/04-06,R
##
## 標本不偏分散の頻度表
