...
table(不偏分散誤差100以上)
     ...
     #+begin_src R :results graphics :file RforS-graphs/04-15-1.png :session *rfors* :tangle RforS-Codes/04-06.R
##
## 標本分散の頻度表
...
#+RESULTS:
     ...
     #+begin_src R :results graphics :file RforS-graphs/04-15-2.png :session *rfors* :tangle RforS-Codes/04-06.R
##
## 標本不偏分散の頻度表
