...
*** 4.5 標本分布
    #+property: header-args:R  :tangle RforS-Codes/04-05.R :session *rfors* :results output
    #+begin shell :exports none
...
**** 4.5.3 正規母集団の母平均の推定
     ...
     #+begin_src R :session *rfors* :tangle RforS-Codes/04-05.R
##
...
**** 4.5.4 標本分布を求める
     ...
     母平均の推定を10000回繰り返し
     #+begin_src R :session *rfors* :results output :tangle RforS-Codes/04-05.R
##
## 母平均の推定
### 母集団 N(50, 10^2) から
### 標本サイズ 10の標本の標本平均
...
1
  ...
  cat("sample_size=", this.sample_size,
     ...
     #+begin_src R :session *rfors* :results graphics :file RforS-graphs/04-12.png :tangle RforS-Codes/04-05.R
...
[[./RforS-graphs/04-15-1.png]] [[./RforS-graphs/04-15-2.png]]
     ...
     #+begin_src R :results output graphics :file RforS-graphs/04-15-3.png :tangle RforS-Codes/04-06.R :session *rfors*
##
## 標本分散の頻度表
##
...
curve(dchisq(x,9), add=TRUE, col="red")
     ...
     #+begin_src R :results output graphics :file RforS-graphs/04-15-4.png :tangle RforS-Codes/04-06.R :session *rfors*
##
## 標本不偏分散の頻度表
##
...
[[./RforS-graphs/04-15-3.png]] [[./RforS-graphs/04-15-4.png]]
