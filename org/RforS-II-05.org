...
- 参考:: [[http://www.ipc.shimane-u.ac.jp/food/kobayasi/soukankeisuunokentei.htm][相関係数の検定の仕方]]
...
#+begin_src R :session *rfors* :results output :exports both :tangle RforS/code/05.R :file RforS/graph/Fig-05-06.png
