...
**** \( \chi^2 \) 分布
 ...
 #+begin_src R ：tangle R-text/code/05.R :session *rtext* :results output graphics :file RforS/graph/05-chisq.png
...
#+begin_src R ：tangle R-text/code/05.R :session *rtext* :results output graphics :file RforS/graph/05-F-1.png
