...
*** \( \mu \) の信頼区間 (を求める公式) を求める
     ...
     \( =  P( \frac{|\overline{X_{(n)}}-\mu|}{\sqrt{\sigma^2/n}} \leq
     z^{*}) \)
...
#+RESULTS:
:  [1] 29.31947 30.47684 29.67857 29.52015 27.38703 30.23326 30.68479 28.25724
:  [9] 28.58880 29.20905 28.86141 29.37965 28.40622 30.30516 29.04846 30.06109
: [17] 27.49247 29.89291 30.40207 28.31730
...
* 10.3 母平均の区間推定 (母分布未知)
  ...
  分散未知の場合は，スチューデント化を用い,
  \( \sigma^2 \) の代わりに標本不偏分散 \( S^2 \) を用いる。
  標本平均のスチューデント化の従う分布は，標準正規分布になる。
