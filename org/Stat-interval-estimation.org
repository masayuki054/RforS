...
#+RESULTS:
:  [1] 30.54355 28.58138 29.51810 28.16354 28.54363 29.41633 28.52214 28.46580
:  [9] 28.43617 30.32315 27.74855 30.41414 29.59607 27.57476 29.56284 27.20942
: [17] 28.42388 28.37821 30.52173 28.39462
...
**** 信頼度 0.95/0.99 の信頼区間は，
     ...
     \( \left[ \overline{X_{(n)}} - 2.09 \sqrt{\sigma^2/n}, \,\,\,
     \overline{X_{(n)}} + 2.09 \sqrt{\sigma^2/n} \right]\)

     \( t^* \) に 2.86 を代入した:

     \( \left[ \overline{X_{(n)}} - 2.86 \sqrt{\sigma^2/n}, \,\,\,
     \overline{X_{(n)}} + 2.86 \sqrt{\sigma^2/n} \right]\)
